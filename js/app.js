...
function renderEventos(arr, page=1, pageSize=PAGE_SIZE){
  ...
  pageItems.forEach(evt => {
    ...
    // Botón "Ver más" lo manejará fav-hist.js (guarda historial + abre modal si existe)
    // Botón de favorito también lo manejará fav-hist.js
...
/* =======================
   Búsqueda / filtros y flujo principal
   ======================= */
